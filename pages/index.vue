<template>
  <div class="homePage content relative">
    ...
    <div
      class="container border-2 border-primary rounded w-11/12 flex items-center h-auto flex-wrap mx-auto my-16"
    >
      <!--Main Col-->
        ...
        <div class="p-4 text-center">
          ...
          >
            <a class="link" href="#" data-tippy-content="@twitter_handle"
              ><svg
                class="h-6 fill-current text-gray-600 hover:text-light"
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
